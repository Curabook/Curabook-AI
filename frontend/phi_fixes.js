...
window.showUpgradeModal = function(reason) {
  ...
  const features = [['fa-syringe','Live drug level tracker'],['fa-file-medical','Lab marker monitoring'],['fa-brain','Full AI health memory'],['fa-shield-halved','PA appeal generator'],['fa-chart-line','Cliff signal detection'],['fa-stethoscope','Doctor visit prep']];
  modal.innerHTML = `
...
async function initiatePayPalCheckout(plan) {
  const PLAN_LABELS = { monthly: 'Shield Monthly', annual: 'Shield Annual' };
